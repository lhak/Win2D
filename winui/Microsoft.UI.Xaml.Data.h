        ...
        namespace UI {
            namespace Xaml {
                namespace Data {
                    ...
                    extern MIDL_CONST_ID IID & IID_IDataErrorsChangedEventArgs=_uuidof(IDataErrorsChangedEventArgs);
        ...
        namespace UI {
            namespace Xaml {
                namespace Data {
                    ...
                    extern MIDL_CONST_ID IID & IID_IDataErrorsChangedEventArgsFactory=_uuidof(IDataErrorsChangedEventArgsFactory);
        ...
        namespace UI {
            namespace Xaml {
                namespace Data {
                    ...
                    extern MIDL_CONST_ID IID & IID_INotifyDataErrorInfo=_uuidof(INotifyDataErrorInfo);
