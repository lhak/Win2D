...
#ifndef ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_FWD_DEFINED__
#define ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_FWD_DEFINED__
namespace ABI {
    namespace Microsoft {
        namespace UI {
            namespace Xaml {
...
#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate ABI::Microsoft::UI::Xaml::Media::Imaging::IXamlRenderingBackgroundTaskStaticsPrivate

#endif // ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_FWD_DEFINED__
...
#define __x_ABI_CMicrosoft_CUI_CXaml_CIResourceDictionary ABI::Microsoft::UI::Xaml::IResourceDictionary
...
#if !defined(____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_INTERFACE_DEFINED__)
#define ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_INTERFACE_DEFINED__
                    ...
                    namespace Imaging {
                        ...
                        public:
                            /* [propget] */virtual HRESULT STDMETHODCALLTYPE get_Resources(
                                /* [retval, out] */ABI::Microsoft::UI::Xaml::IResourceDictionary * * value
                                ) = 0;
...
EXTERN_C const IID IID___x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate;
#endif /* !defined(____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_INTERFACE_DEFINED__) */
...
#ifndef ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_FWD_DEFINED__
#define ____x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_FWD_DEFINED__
typedef interface __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Microsoft_UI_Xaml_Media_Imaging_IXamlRenderingBackgroundTaskStaticsPrivate[] = L"Microsoft.UI.Xaml.Media.Imaging.IXamlRenderingBackgroundTaskStaticsPrivate";
/* [object, uuid("F5FBD758-16CA-5318-BE90-C3D76A127DCA"), contract] */
typedef struct __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivateVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
/* [propget] */HRESULT ( STDMETHODCALLTYPE *get_Resources )(
        __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate * This,
        /* [retval, out] */__x_ABI_CMicrosoft_CUI_CXaml_CIResourceDictionary * * value
        );
...
} __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivateVtbl;

interface __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate
{
    CONST_VTBL struct __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivateVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_GetTrustLevel(This,trustLevel) \
        ( (This)->lpVtbl->GetTrustLevel(This,trustLevel) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_get_Resources(This,value) \
    ( (This)->lpVtbl->get_Resources(This,value) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_EnableStandaloneHosting(This) \
    ( (This)->lpVtbl->EnableStandaloneHosting(This) )

#define __x_ABI_CMicrosoft_CUI_CXaml_CMedia_CImaging_CIXamlRenderingBackgroundTaskStaticsPrivate_SetScalePercentage(This,percentage) \
